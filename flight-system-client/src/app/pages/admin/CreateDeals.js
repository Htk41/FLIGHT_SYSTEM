...
import { createDeals } from "../../crud/flights.crud";
import { formErrorMessage } from "../errors/FormErrorMessage";
import CKEditor from "@ckeditor/ckeditor5-react";
import ClassicEditor from "@ckeditor/ckeditor5-build-classic";
import clsx from "clsx";
import { DealsCreateValidations } from "../../../utils/validations/worldTourCreateValidations";
  ...
  return (
    <div className="pb-5">
      <Portlet className="kt-portlet--height-fluid-half kt-portlet--border-bottom-brand">
        <PortletHeader title="Create  Deals" />
        <PortletBody>
          ...
          <div className="row container">
            <Formik
              ...
              validate={DealsCreateValidations}
