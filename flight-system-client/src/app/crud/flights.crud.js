...
export const DELETE_DEAL_PACKAGE =
  "/api/flights/deals/delete-package";
export const CREATE_WORLD_TOUR = "/api/flights/create/world-tour/images";
export const CREATE_DEALS = "/api/flights/create/deals/images";
export const GET_WORLD_TOUR = "/api/flights/world-tour";
export const GET_DEALS = "/api/flights/deals";
export const GET_WORLD_TOUR_PACKAGE = "/api/flights/world-tour/package";
export const GET_DEAL_PACKAGE = "/api/flights/deals/package";
...
export function deleteDealPackage(data) {
  return axios.put(DELETE_DEAL_PACKAGE, data);
}
...
export function createDeals(data) {
  return axios.post(CREATE_DEALS, data);
}
...
export function getDealPackage({ dealId }) {
  return axios.get(`${GET_DEAL_PACKAGE}?dealId=${dealId}`);
}
